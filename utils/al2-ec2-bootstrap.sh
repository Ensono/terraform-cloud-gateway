...
# echo -e "[profile group-idam]\nrole_arn = arn:aws:iam::462418267981:role/iag-idam-sharedservices-ssvc-root-satellite-components\ncredential_source = Ec2InstanceMetadata\nregion = eu-west-1" > ~/.aws/config
...
aws s3 cp s3://iag-idam-sharedservices-ssvc-root-satellite-components/identityiq-CloudGateway-8.1-modified.zip identityiq-CloudGateway-8.1-modified.zip # --profile group-idam 
